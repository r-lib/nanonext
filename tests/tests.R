...
if (Sys.getenv("NOT_CRAN") == "true") {
  ...
  task_msg2 <- raw(13)
  task_msg2[1] <- as.raw(0x07)
  task_msg2[5] <- as.raw(2L)
  send(client, task_msg2, mode = "raw", block = 2000)
  ...
  send(client, raw(8), mode = "raw", block = 2000)
  status2 <- recv(client, mode = "integer", block = 2000)
  test_equal(status2[1L], 0L)
  close(client)
  Sys.sleep(0.5)
  unlink(script)
}
