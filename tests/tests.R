...
test_error(pipe_register(err, cv), "valid Socket")
test_error(pipe_notify(rep, err), "valid Condition Variable")
test_error(pipe_register(rep, err), "valid function")
test_error(pipe_register(rep, NULL, err), "valid function")
test_zero(pipe_register(rep, NULL,NULL))
