...
[`recv_aio()`](https://nanonext.r-lib.org/reference/recv_aio.md) - async
send/receive -
[`request()`](https://nanonext.r-lib.org/reference/request.md) - async
request/reply -
...
[`unresolved()`](https://nanonext.r-lib.org/reference/unresolved.md) to
check status
...
- Condition variables
  ([`cv()`](https://nanonext.r-lib.org/reference/cv.md)) for
