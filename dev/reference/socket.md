...
[`dial()`](https://nanonext.r-lib.org/dev/reference/dial.md) and
[`listen()`](https://nanonext.r-lib.org/dev/reference/listen.md).

New contexts may also be created using
[`context()`](https://nanonext.r-lib.org/dev/reference/context.md) if
...
Please see
[protocols](https://nanonext.r-lib.org/dev/reference/protocols.md) for
...
Please see
[transports](https://nanonext.r-lib.org/dev/reference/transports.md) for
further documentation.
