...
[`.dispatcher_gate()`](https://nanonext.r-lib.org/dev/reference/dot-dispatcher_gate.md).
...
[`.dispatcher_start()`](https://nanonext.r-lib.org/dev/reference/dot-dispatcher_start.md),
