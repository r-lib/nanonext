...
[`recv()`](https://nanonext.r-lib.org/dev/reference/recv.md) or their
async counterparts
...
[`nano()`](https://nanonext.r-lib.org/dev/reference/nano.md).

## See also

[`request()`](https://nanonext.r-lib.org/dev/reference/request.md) and
[`reply()`](https://nanonext.r-lib.org/dev/reference/reply.md) for use
with contexts.
