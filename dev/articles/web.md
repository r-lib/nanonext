...
nanonext provides high-performance web utilities built on NNG, serving
as both an HTTP/WebSocket client and server. These capabilities support
building REST APIs, real-time streaming applications, and interactive
web services entirely in R.
