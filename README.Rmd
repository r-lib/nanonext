...
Uses a system 'libnng' >= v1.12.3 and 'libmbedtls' v3.x if present, otherwise compiles the bundled sources (libnng v1.12.3, libmbedtls v3.6.5) directly into the package - requiring only a C compiler.
...
Requires Rtools. The bundled libraries are compiled directly by Rtools - no additional tools are needed.
