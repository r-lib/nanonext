...
R binding for [NNG (Nanomsg Next Gen)](https://nng.nanomsg.org/), a high-performance messaging library. Lightweight, implemented almost entirely in C.
...
- **Web utilities** - HTTP client/server, WebSocket, streaming (SSE, NDJSON)
...
HTTP/WebSocket client and server, with streaming support for SSE and NDJSON. Mbed TLS for secure connections.
