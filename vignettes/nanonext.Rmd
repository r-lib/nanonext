...
The [`mirai`](https://doi.org/10.5281/zenodo.7912722) package (<https://r-lib.github.io/mirai/>) uses `nanonext` as the back-end to provide asynchronous execution of arbitrary R code using the RPC model.
