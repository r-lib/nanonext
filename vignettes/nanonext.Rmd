...
#>  num [1:100000000] -1.667 1.719 0.567 -0.244 1.141 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t1744534811.445\",\n    \"connection\": \"close\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-67fb7d1b-1d147c3623db22b43c9f2e4b\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Sun, 13 Apr 2025 09:00:12 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t1744534812.119\",\n    \"connection\": \"close\",\n    \"content-length\": \"16\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-67fb7d1b-1edc80066be394bb2ebdd1c2\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> $headers
#> $headers$Date
#> [1] "Sun, 13 Apr 2025 09:00:14 GMT"
#> 
...
#>  [73] 71 75 65 73 74 2d 73 74 61 72 74 22 3a 20 22 74 31 37 34 34 35 33 34 38 31 32 2e 37 33 30 22 2c 0a 20 20 20
...
#> [217] 64 22 3a 20 22 52 6f 6f 74 3d 31 2d 36 37 66 62 37 64 31 63 2d 32 65 36 65 36 37 63 35 36 62 34 39 37 64 63
#> [253] 37 32 33 39 34 39 38 66 37 22 2c 0a 20 20 20 20 22 63 6f 6e 74 65 6e 74 2d 74 79 70 65 22 3a 20 22 61 70 70
