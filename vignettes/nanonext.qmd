...
#>  num [1:100000000] 0.9289 -1.8444 0.0847 -0.1721 -0.9405 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t1756323314.805\",\n    \"connection\": \"close\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-68af5df2-47904213688be88a30931d96\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Wed, 27 Aug 2025 19:35:15 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t1756323315.643\",\n    \"connection\": \"close\",\n    \"content-length\": \"16\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-68af5df3-3ddfe6da4e8a50145b4dac94\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> $headers
#> $headers$Date
#> [1] "Wed, 27 Aug 2025 19:35:16 GMT"
#> 
...
#>  [73] 71 75 65 73 74 2d 73 74 61 72 74 22 3a 20 22 74 31 37 35 36 33 32 33 33 31 36 2e 30 37 32 22 2c 0a 20 20 20
...
#> [217] 64 22 3a 20 22 52 6f 6f 74 3d 31 2d 36 38 61 66 35 64 66 34 2d 36 33 34 31 32 65 64 66 35 66 37 34 33 39 36
#> [253] 30 34 61 34 63 32 33 64 65 22 2c 0a 20 20 20 20 22 63 6f 6e 74 65 6e 74 2d 74 79 70 65 22 3a 20 22 61 70 70
