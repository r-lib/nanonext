...
#> $headers
#> $headers$date
#> [1] "Sat, 07 Feb 2026 19:43:40 GMT"
#> 
#> 
#> $data
...
#> $headers
#> $headers$Date
#> [1] "Sat, 07 Feb 2026 19:43:41 GMT"
#> 
...
#> 
#> $headers$`Set-Cookie`
#> [1] "sails.sid=s%3AK3m5xa7-usqJ1o1xSl6A82Gkc5B6TdoA.rRzl7KNGFbTGWt7VNEwNV8oDHv8NJFuc6%2BlwrVxZXNw; Path=/; HttpOnly, __cf_bm=jt0yThIQ_4Cy3vCqexjRnnEpoyJjoJhZaLfcjHxrHZo-1770493421-1.0.1.1-pq0P2hoYcRMW1w0z.hfXr3C9jHB3_NAXVHgx_KybZxoZCJ3_JX6_laYXYPxbRkFK.j45GaFe5_3Tzkp5iss97M.30fY7pfOX8rWCWTFG6c8; path=/; expires=Sat, 07-Feb-26 20:13:41 GMT; domain=.postman-echo.com; HttpOnly; Secure, _cfuvid=r3GbLU8Eg7ulxWB.d6BVYk9usJpOaBUisgqG82JRs_w-1770493421009-0.0.1.1-604800000; path=/; domain=.postman-echo.com; HttpOnly; Secure; SameSite=None"
#> 
