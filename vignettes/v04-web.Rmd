...
Static pages are served at native speed by NNG while the prediction endpoint is handled by R. Without requiring separate processes or ports, you can even add TLS with just a single argument.
