...
by [`request()`](https://nanonext.r-lib.org/reference/request.md). This
is an augmented version of
[`stop_aio()`](https://nanonext.r-lib.org/reference/stop_aio.md) that
additionally requests cancellation by sending an integer zero followed
by the context ID over the context, and waiting for the response.
